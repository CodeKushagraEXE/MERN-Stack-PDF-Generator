          ...
          <div className="flex flex-col justify-center items-center w-full md:w-1/2 p-8 md:p-16">
            ...
            <form className="flex flex-col gap-4 w-full max-w-md">
              <div>
                ...
                <input type="text" placeholder="Enter your name" className="border border-[#23272F] rounded-lg px-4 py-2 w-full bg-[#23272F] text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#A3E635]" />
